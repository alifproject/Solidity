...
contract ALIF is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = //PoolMarketing
        payable(address(0xBa84DE46F6eB9951afC3b8B88208f97BF37EaFDb));


    string private _name = "ALIF";
    string private _symbol = "alif";
